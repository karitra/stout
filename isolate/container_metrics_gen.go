...
func (z *WorkerMetrics) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendFloat64(o, z.CpuLoad)
	// string "mem"
...
func (z *WorkerMetrics) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "cpu_load":
			z.CpuLoad, bts, err = msgp.ReadFloat64Bytes(bts)
			if err != nil {
				return
			}
		case "mem":
...
func (z *WorkerMetrics) Msgsize() (s int) {
	s = 1 + 7 + msgp.Uint64Size + 10 + msgp.Uint64Size + 9 + msgp.Float64Size + 4 + msgp.Uint64Size + 4 + msgp.MapHeaderSize
	if z.Net != nil {
		for za0001, za0002 := range z.Net {
			_ = za0002
